...
# NOTE(robin): check hyprctl monitors for available monitors and their resolutions
...
LAPTOP_RESOLUTION="preferred"            # Laptop monitor resolution@refresh
EXTERNAL_SCALE="1.6"                     # External monitor scaling factor
LAPTOP_SCALE="1.6"                       # Laptop monitor scaling factor
